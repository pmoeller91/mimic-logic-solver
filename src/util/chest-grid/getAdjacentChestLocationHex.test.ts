...
describe("getAdjacentChestLocationHex", () => {
  describe("for invalid directions", () => {
    ...
    ] as const)("should return null when the direction is $directionName", ({ direction }) => {
  ...
  describe("for valid movements", () => {
    it.each<{
      ...
      ({ direction, startLocation, expectedLocation }) => {
        expect(getAdjacentChestLocationHex({ location: startLocation, direction })).toEqual(
          expectedLocation,
        );
      },
    );
  ...
  describe("for invalid movements", () => {
    it.each<{
      ...
      ({ direction, startLocation }) => {
        expect(getAdjacentChestLocationHex({ location: startLocation, direction })).toEqual(null);
      },
    );
  });
});
