...
import { EditGameInfoView, EditGameInfoViewTranslations } from "./EditGameInfoView";
...
const EditGameInfoContainer = forwardRef<HTMLDivElement, EditGameInfoContainerProps>(
  function EditGameInfoContainer({ onClose, additionalProps }: EditGameInfoContainerProps, ref) {
