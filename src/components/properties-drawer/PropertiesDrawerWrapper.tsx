...
const PropertiesDrawerWrapper = forwardRef<HTMLDivElement, PropertiesDrawerWrapperProps>(
  function PropertiesDrawerWrapper({ direction, children, className, ...extraProps }, ref) {
    const sharedClasses = "bg-bg-dark flex flex-col fixed bottom-0 right-0 border-slate-500 ";
