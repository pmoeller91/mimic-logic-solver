...
const isValidLocation = (location: ChestLocation): location is [0 | 1 | 2, 0 | 1 | 2] =>
  location.every((coordinate) => validCoordinates.includes(coordinate as 0 | 1 | 2));

function ChestTileContainer(props: ChestTileContainerPropsWithEdit): JSX.Element;
function ChestTileContainer(props: ChestTileContainerPropsWithoutEdit): JSX.Element;
